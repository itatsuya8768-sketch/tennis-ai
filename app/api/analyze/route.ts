...
9. 【踏み込みの判定は厳格に】「踏み込んでいる」と書くのは、動画で実際に足が前（ネット方向）へ出て体重が前足に移るのが確認できた場合だけ。足が動いていない・その場で打っている・どちらの足も前に出ていない場合は、絶対に「踏み込んでいる」と書かず、「踏み込みができていない／その場で打っている」と正直に評価する。「踏み込めている前提」で書き始めない。テンプレ的に「しっかり踏み込めています」と書くことを禁止する。
