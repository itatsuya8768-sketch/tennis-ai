    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#f0fdf4,#f8fafc)", padding: "24px 16px" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={card}>
          ...
          <p style={p}>Premiumプランは月額¥999（税込）で、毎月自動的に更新（継続課金）されます。<strong>Premiumプランでは1か月あたり30回まで診断をご利用いただけます。</strong>決済はStripe社を通じて行われます。解約はいつでも可能で、解約後はPremium機能の利用が停止します。日割り返金は行いません（法令で必要な場合を除く）。</p>
